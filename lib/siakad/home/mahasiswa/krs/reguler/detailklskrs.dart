...
import '../../../../model/detailklskrsmodel.dart';
import '../../../../settings/constant.dart';

class DetailKlsKrs extends StatefulWidget {
  const DetailKlsKrs({super.key});

  @override
  State<DetailKlsKrs> createState() => _DetailKlsKrsState();
}

class _DetailKlsKrsState extends State<DetailKlsKrs> {
