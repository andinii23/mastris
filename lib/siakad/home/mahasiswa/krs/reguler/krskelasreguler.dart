...
import '../../../../model/kelasregulermodel.dart';
import '../../../../settings/constant.dart';

class KrsKelasReguler extends StatefulWidget {
  const KrsKelasReguler({super.key});

  @override
  State<KrsKelasReguler> createState() => _KrsKelasRegulerState();
}

class _KrsKelasRegulerState extends State<KrsKelasReguler> {
  ...
  Widget build(BuildContext context) {
   ...
   Future _idMatakuliah(String idMatakuliah) async {
    ...
    Navigator.pushNamed(context, 'listklskrs');
  }
}