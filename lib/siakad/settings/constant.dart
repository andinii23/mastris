...
final mainLBlueColor = Color(0xff5479AA);

final main_url = "https://devm-ws.unja.ac.id/";
// final main_url = "https://ws.unja.ac.id/";
final login_url = main_url + "api/login";
final register =
    main_url + "api/siakad/registrasi?order_by=id_semester&order_dir=desc";
...
final krs_outbound_pt = main_url +
    "api/siakad/pertukaran-pelajar/perguruan-tinggi?nama_pt=Universitas Jambi&per_page=10";

final detail_krs_kelas = main_url + "api/siakad/krs/kelas/";
final tagihan =
    main_url + "api/siakad/tagihan?order_by=waktu_open&order_dir=desc";
final biodata = main_url + "api/siakad/biodata";
final semester =
    main_url + "api/siakad/semester?order_by=id_semester&order_dir=desc";
final semestermhs = main_url +
    "api/siakad/semester-mahasiswa?order_by=create_date&order_dir=desc";
...
final monitorkuliah =
    main_url + "api/siakad/monitoring-perkuliahan?id_semester=";
final monitorperkelas = main_url + "api/siakad/monitoring-perkuliahan/";
final monitorperkelasdetail =
    main_url + "api/siakad/monitoring-perkuliahan/detail-pertemuan/";
...
final detailkrs_kelasoutbound =
    main_url + "api/siakad/krs/detail-matakuliah-outbound/";
...
final hapusmonitor = main_url + "api/siakad/monitoring-perkuliahan";

final berita = main_url + "https://unja.ac.id/wp-json/wp/v2/posts";

//elista
// mhs
final metodepenelitian = main_url + "api/elista/metode-penelitian";
final jenisdatapenelitian = main_url + "api/elista/jenis-data-penelitian";
final jenispenggunaan = main_url + "api/elista/jenis-penggunaan";
final jenisexplanasi = main_url + "api/elista/jenis-explanasi";
final agendabim = main_url + "api/elista/agenda-bimbingan";
final datapenelitian = main_url + "api/elista/data-penelitian";
final cekkelayakansempro = main_url + "api/elista/cek-kelayakan/seminar-proposal";
final prosesbimbingan =
    main_url + "api/elista/proses-bimbingan/status-progress";

// dosen
final mhsbimelista = main_url + "api/elista/mahasiswa-bimbingan";
final detailmhsbimelista = main_url + "api/elista/mahasiswa-bimbingan/";
final timelinelista = main_url + "api/elista/timeline-mahasiswa";
final arsipberitaacara = main_url + "api/elista/arsip-berita-acara";
final jadwalujian = main_url + "api/elista/jadwal-ujian/46093";
