...
DetailKurikulum detailKurikulumFromJson(String str) =>
    DetailKurikulum.fromJson(json.decode(str));

String detailKurikulumToJson(DetailKurikulum data) =>
...
class DetailKurikulum {
  ...
  factory DetailKurikulum.fromJson(Map<String, dynamic> json) =>
      DetailKurikulum(
        code: json["code"],
...
class ListClass {
  ...
  factory ListClass.fromJson(Map<String, dynamic> json) => ListClass(
        ...
        listMataKuliah: List<ListMataKuliah>.from(
            json["list_mata_kuliah"].map((x) => ListMataKuliah.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "list_mata_kuliah":
            List<dynamic>.from(listMataKuliah.map((x) => x.toJson())),
      };
}
